...
Four network topologies where considered: Erdos-Reyni (ER), Barabasi-Albert (BA), Stochastic-block-model (SBM) and the real-world network of Western States Power Grids of the United States (RW) (see appendix for RW).
